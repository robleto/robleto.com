...
const Subhead: React.FC<SubheadProps> = ({ pageContent }) => {
	return (
		<section className="notion-page-content font-medium text-lg md:text-xl italic font-bodoni text-center max-w-prose mx-auto mt-0 pb-4 mb-8 md:px-[20%] leading-5 md:leading-6 text-gray-800 dark:text-gray-200">
