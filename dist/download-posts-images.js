...
function getPostsImages() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return response.results
            ...
            const title = ((_b = (_a = entry.properties.Name) === null || _a === void 0 ? void 0 : _a.title[0]) === null || _b === void 0 ? void 0 : _b.plain_text) || "untitled"; // Use "Name" instead of "Title"
...
function downloadImages() {
    return __awaiter(this, void 0, void 0, function* () {
        const publicPath = path_1.default.join(process.cwd(), "public", "posts");
        if (!fs_1.default.existsSync(publicPath)) {
            fs_1.default.mkdirSync(publicPath, { recursive: true });
            console.log("Created posts directory.");
        }
        try {
            const images = yield getPostsImages();
            console.log(`Found ${images.length} images. Starting download...`);
            yield Promise.all(images
                .filter((image) => image !== null)
                .map(({ url, title }) => downloadImage(url, path_1.default.join(publicPath, `${title}.png`))));
